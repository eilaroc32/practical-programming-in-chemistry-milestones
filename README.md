...
| Week | Milestone                                   | Link                                                                        |      
|------|---------------------------------------------|-----------------------------------------------------------------------------|
| 1    | Github Account Created                      | https://github.com/eilaroc32                                               | 
| 1    | Github Profile Page                         | https://github.com/eilaroc32/eilaroc32                                    |
| 1    | Commit and Push Change from Command Line    | https://github.com/eilaroc32/ppchem/commit/665b542d80741ccbbf9c0ea3aaf7a42379247b2a               |
| 1    | Create a New Branch                         | https://github.com/eilaroc32/ppchem/tree/new-branch-name        |
| 1    | Create a conda environment                  | https://github.com/eilaroc32/ppchem/blob/main/env.yml     |
| 1    | Fork a Repo                                 | https://github.com/eilaroc32/practical-programming-in-chemistry-milestones |
| 1    | (Optional) Make a Pull Request              | https://github.com/enitsuj23/ppchem/pull/1|
| 2    | (Optional) Review a Pull Request            |https://github.com/eilaroc32/ppchem/pull/2#issuecomment-1971269079 |
| 4    | Update `env.yml` via a Pull Request         | https://github.com/eilaroc32/ppchem/pull/3/ |
